        ...
        <div className="first-footer">
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="newsletter-form-div">
                  <div className="newsletter-form-title">
                    <h3 className="widget-title">Subscribe With Us</h3>
                  ...
                  <form id="subscribe-form" className="newsletter-form" method="post" action="#" data-mailchimp="true">
                    <div className="ttm_subscribe_form">
                      ...
                      <button className="submit ttm-btn ttm-btn-size-md ttm-btn-style-fill ttm-btn-color-skincolor" type="submit">Message</button>
                    </div>
              ...
              <div className="col-md-6">
                <div className="row">
                  <div className="col-lg-6 res-767-pl-0 res-767-pr-0">
                    <p>Serving Oregon & Washington</p>
                    <p>With trusted healthcare professionals</p>
                    <div className="ttm-horizontal_sep mt-25 res-991-w-50"></div>
                    <div className="ttm-fid inside style6">
                      <div className="ttm-fid-contents">
                        <h4 className="ttm-fid-inner">
                          <span className="numinate">25</span><span>+</span>
                        </h4>
                        <h3>Healthcare Facilities</h3>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-6 align-self-center res-767-pl-0 res-767-pr-0">
                    <div className="d-flex justify-content-start justify-content-lg-end">
                      <Link to="/contact-us" className="ttm-btn ttm-btn-size-md ttm-btn-style-border ttm-btn-color-white">View Our Locations</Link>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-3 widget-area">
                <div className="widget widget-widget_contact clearfix">
                  ...
                  <div className="textwidget widget-text">
                    <p>Hope Medical is a medical staffing agency located in Portland, Oregon. We provide Oregon and Washington with the best healthcare professionals and exceptional care to all our clients.</p>
                  </div>
              ...
              <div className="col-lg-3 widget-area">
                <div className="widget widget-widget_contact clearfix">
                  ...
                  <ul className="widget_contact_wrapper">
                    <li>Phone: <a href="tel:7122038160">712-203-8160</a></li>
                    <li>Email: <a href="mailto:hopemedicalstaffing@gmail.com">hopemedicalstaffing@gmail.com</a></li>
