              ...
              <div className="col-lg-6 col-md-6">
                ...
                <div className="section-title mb-0">
                  <div className="title-header">
                    ...
                    <h2 className="title">What Our Clients Say About Our Healthcare Staffing Services</h2>
                  </div>
                </div>
                {/* <!-- section title end --> */}
              </div>
                ...
                <div className="d-flex justify-content-start justify-content-md-center">
                  <div className="ttm-fid inside ttm-fid-with-icon ttm-fid-boxed-view ttm-fid-view-lefticon style4 ttm-textcolor-white">
                    ...
                    <div className="ttm-fid-contents">
                      ...
                      <h3 className="ttm-fid-title">Satisfied Healthcare Professionals & Clients</h3>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="col-lg-5 align-self-center">
            <div>
              ...
              <div className="pb-20 pt-15 res-991-pb-0">
                <div className="ttm-progress-bar style3 mb-35 res-991-mb-30" data-percent="75%">
                  <div className="progress-bar-title">Staffing Placement Success Rate</div>
                  <div className="progress-bar-inner">
                    <div className="progress-bar progress-bar-color-bar_skincolor"></div>
                  </div>
                  <div className="progress-bar-percent" data-percentage="75"></div>
                </div>
                <div className="ttm-progress-bar style3" data-percent="95%">
                  <div className="progress-bar-title">Client Satisfaction Rate</div>
                  <div className="progress-bar-inner">
                    <div className="progress-bar progress-bar-color-bar_skincolor"></div>
                  </div>
                  <div className="progress-bar-percent" data-percentage="95"></div>
                </div>
              </div>
              {/* <!-- progress-bar END --> */}
            </div>
