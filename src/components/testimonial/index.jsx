...
const Testimonial = () => {
  ...
  return (
    <section
      className="ttm-row zero_padding-section testimonial-section-homepage clearfix"
    ...
    >
      ...
      >
        <div className="row g-0" style={{ margin: 0 }}>
                  ...
                  <div className="col-lg-12">
                    <div className="section-title mb-18">
                      <div className="title-header">
                        <h3 className="ttm-textcolor-white">TESTIMONIALS</h3>
                ...
                <div className="featured-icon-box icon-align-before-content style20">
                  ...
                  <div className="featured-content">
                    <div className="featured-desc">
                      <p>
                        If you have any questions or need help contact with our
                        team, or call
                        <Link to="contact-us">
                          <span> (003) 123 456 7890 </span>
                        </Link>
                      </p>
                    </div>
                  </div>
          ...
          <div
            className="col-xl-7 col-lg-12 pt-60 res-1199-pt-0"
            style={{ overflow: "hidden" }}
          >
            <div
              className="box-shadow ttm-bg ttm-col-bgimage-yes ttm-right-span col-bg-img-eleven spacing-22"
              style={{ overflow: "hidden" }}
            >
