            ...
            <div className="col-lg-12 content-area pt-90 res-991-pt-50">
              <article className="ttm-service-single-content-area">
                <div className="row">
                      ...
                      {[0, 1].map((col) => (
                        <div className="col-md-6" key={col}>
                          <ul className="ttm-list ttm-list-style-icon style1">
                            {service.features.slice(col * 3, col * 3 + 3).map((feat, idx) => (
                              <li key={idx}>
                                <i className="icon-ok"></i>
                                <span className="ttm-list-li-content">{feat}</span>
                              </li>
                            ))}
                          </ul>
                        </div>
                  ...
                  <div className="col-lg-6 res-991-pt-15">
                    <div className="ttm_single_image-wrapper">
                      <img className="img-fluid" src={service.images[0]} alt="service-img-1" />
                    </div>
                  </div>
                </div>
                <div className="row pt-70 res-991-pt-0 res-991-mt-30">
                  <div className="col-lg-6">
                    <div className="ttm_single_image-wrapper">
                      <img className="img-fluid" src={service.images[1]} alt="service-img-2" />
                    </div>
                  </div>
                  <div className="col-lg-6 res-991-mt-30">
                    <div className="section-title">
                      <div className="title-header">
                        <h2 className="title">Partner with Staffing Experts Today</h2>
                      </div>
                    </div>
                    <div className="mt_5">
                      <p>Our staffing specialists are ready to help you fill critical healthcare roles quickly and reliably. Contact us to get started.</p>
                    </div>
                    <div className="pt-50 res-991-pt-30 d-flex flex-wrap flex-column flex-sm-row">
                      <div className="res-991-mb-15">
                        <a className="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-fill ttm-btn-color-darkgrey ttm-textcolor-white" href="/contact-us">request staff</a>
                      </div>
                      <div className="ml-25 res-575-ml-0">
                        <a className="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor" href="/contact-us-2">contact us</a>
                      </div>
                    </div>
                  </div>
                </div>
